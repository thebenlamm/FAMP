...
use crate::cli::error::CliError::{
    AlreadyInitialized, AwaitTimeout, BrokerUnreachable, BusError, CertgenFailed, Envelope,
    FsmTransition, HomeCreateFailed, HomeHasNoParent, HomeNotAbsolute, HomeNotSet,
