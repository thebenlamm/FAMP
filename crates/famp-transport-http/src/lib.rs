...
mod tests {
    ...
    fn middleware_error_status_mapping_is_load_bearing() {
        ...
        assert_eq!(
            MiddlewareError::CanonicalDivergence
                .into_response()
                .status()
                .as_u16(),
            400
        ...
        assert_eq!(
            MiddlewareError::SignatureInvalid
                .into_response()
                .status()
                .as_u16(),
            401
        ...
        assert_eq!(
            MiddlewareError::UnknownRecipient
                .into_response()
                .status()
                .as_u16(),
            404
        ...
        assert_eq!(
            MiddlewareError::Internal.into_response().status().as_u16(),
            500
        );
    }
}
