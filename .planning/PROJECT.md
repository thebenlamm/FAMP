...
### Active — v0.11 Broker Daemon & Cross-Tool Bootstrap — IN PROGRESS
...
## Current Milestone: v0.11 Broker Daemon & Cross-Tool Bootstrap
...
**Next:** v1.0 Federation Profile — **trigger-gated**. Cross-host FAMP-over-HTTPS via `famp-gateway` wrapping the local bus; Agent Cards + federation credentials; negotiation/delegation/provenance; conformance vector pack. Trigger named: Sofer (or named equivalent) runs FAMP from a different machine and exchanges a signed envelope. **4-week clock running 2026-05-04 → 2026-06-01.** If untriggered, federation framing is reconsidered.
