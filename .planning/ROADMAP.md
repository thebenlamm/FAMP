...
- [ ] 07-01-PLAN.md — famp-gateway crate scaffold + connect-with-own-PID mechanism (ProxiedPrincipal/GatewayRegistry/bin) + no-spawn BusClient constructor (LIVE-01, LIVE-02, GW-04)
...
| 7. Broker-Liveness Fork + Gateway Skeleton | v1.0 | 0/TBD | Not started | - |
