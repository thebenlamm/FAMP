...
Plan: 3/3 complete
Status: All v0.8 phases shipped
Last activity: 2026-04-25 - Completed quick task 260425-rz6: Fix CliError::Envelope masking FSM transition errors — added FsmTransition + InvalidTaskState variants, wired through fsm_glue, MCP kind strings now distinct
